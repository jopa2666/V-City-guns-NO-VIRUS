-- "addons\\hg_firearms\\lua\\weapons\\weapon_akm.lua"
...
if 1 then
    ...
    SWEP.ViewModel				= "models/weapons/zcity/akpack/w_akm.mdl"
    ...
    SWEP.Recoil = 0.05
    SWEP.Primary.Sound = {"zcitysnd/sound/weapons/firearms/rifle_sks/sks_fire_01.wav"}
    ...
    SWEP.CameraPos = Vector(5.35,3.5,0.815)
    ...
    SWEP.SlideVector = Vector(-10, 1, -0.6)  
    ...
    SWEP.UsingVM = true
    SWEP.addAng = Angle(-5.2,0,0)
    SWEP.addPos = Vector(0,-0.1,6)
